      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col gap-12 mb-24">
          <div className="max-w-4xl">
            ...
            <h1 className="text-6xl md:text-9xl font-display font-black uppercase tracking-tighter leading-[0.85] mb-8 animate-slide-up text-brand-black/50">
              {project.title}
            </h1>
          </div>
        ...
        {/* Project Details - Simplified Single Column */}
        <div className="max-w-4xl mb-24">
          <h2 className="text-3xl font-display font-black uppercase border-b border-brand-black/5 pb-6 mb-8">Project Overview</h2>
          <p className="text-2xl leading-relaxed text-brand-black/70 font-light">
        ...
        <div className="space-y-12 mb-32">
          <h2 className="text-3xl font-display font-black uppercase text-center">Selected Stills</h2>
